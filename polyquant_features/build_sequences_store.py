...
#   p_yes, price, outcome_index, dp_yes, dt_trade, log_usdc_size, user_hash
#
# user data:
...
# market_id, timestamp,
# p_yes, price, outcome_index, dp_yes_clip, log_dt, log_usdc_size, user_hash,
