#!/usr/bin/env python
"""
Evaluation script for ResNet models on the test set.

Usage:
    python -m polyquant.evaluation.eval_resnet --checkpoint path/to/checkpoint.pt
...
# HIDDEN_DIMS = (256, 256, 512, 1024, 512, 512, 1024, 2048, 4096, 1024, 512, 256, 128, 32)
HIDDEN_DIMS = (256, 512, 1024, 2048, 1024, 512, 256, 128, 32)
DROPOUT = 0.2
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate ResNet checkpoint on test set"
    )
    parser.add_argument(
        "--checkpoint",
        type=str,
    ...
    print_results_header("ResNet", checkpoint_path)
    ...
    save_results_to_file(output_path, checkpoint_info, metrics, "resnet", extra_info)
